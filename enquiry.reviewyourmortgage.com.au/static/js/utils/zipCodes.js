...
export const getZipCodeList = (postcode) => {
  return zipCodes.filter((item) => {
    return item.includes(postcode);
  });
};

export const getZipcodeOptions = (postcode) => {
  return zipCodes
    .filter((item) => item.includes(postcode))
    .map((item) => ({ value: item, label: item }));
};

export const getZipCodeOptionsPostCode = (postcode) => {
  if (postcode.length === 2) {
    return zipCodes
      .filter(
        (item) =>
          item.includes(postcode) && item.substr(-4).slice(0, 2) === postcode
      )
      .map((item) => ({ value: item, label: item }));
  }
  ...
  if (postcode.length === 3) {
    return zipCodes
      .filter(
        (item) =>
          item.includes(postcode) && item.substr(-4).slice(0, 3) === postcode
      )
      .map((item) => ({ value: item, label: item }));
  }
  return zipCodes
...
export const parseZipCodeToObject = (postcodeString) => {
  const parseToArray = postcodeString.split(",");
  const city =
    parseToArray[0] !== undefined ? parseToArray[0].trim() : "unknown";
  const state =
    parseToArray[1] !== undefined ? parseToArray[1].trim() : "unknown";
  const postcode =
    parseToArray[2] !== undefined ? parseToArray[2].trim() : "unknown";
  return { city, state, postcode };
};

export const zipCodes = [
  "(Keeling) Islands, WA, 6799",
  "700–762 Osborne Park, WA, 6917",
  ...
  "Alison, NSW, 2259",
  "Alison (Wyong), NSW, 2420",
  "Alkimos (Dungog), WA, 6038",
  "Allambee, VIC, 3823",
  ...
  "Australian National Forces, NSW, 2890",
  "Australind, WA, 6233",
  "Avalon, VIC, 3212",
  ...
  "Back Creek, NSW, 2622",
  "Back Creek, NSW, 2671",
  "Back Creek (Gloucester), NSW, 2484",
  "Back Creek (Narrabri), NSW, 2422",
  "Back Creek (Tenterfield), NSW, 2390",
  ...
  "Bakers Creek (Macksville), QLD, 4740",
  "Bakers Hill, WA, 6562",
  ...
  "Balmoral, NSW, 2283",
  "Balmoral, QLD, 4171",
  "Balmoral (Picton), VIC, 3407",
  "Balmoral (Rathmines), NSW, 2571",
  ...
  "Barry, NSW, 2340",
  "Barry (Tamworth), NSW, 2799",
  "Barrys Reef (Blayney), VIC, 3458",
  ...
  "Batemans Bay Lilli Pilli, NSW, 2536",
  "Batemans Bay Woodlands, NSW, 2536",
  "Batesford, VIC, 3213",
  "Bathampton, NSW, 2795",
  "Bathumi, VIC, 3730",
  "Bathurst, NSW, 2795",
  ...
  "Bay Cedar Grove (Moreton), QLD, 4285",
  ...
  "Blue Mountains Yellow Rock, NSW, 2777",
  "Blue Nobby, NSW, 2408",
  "Blue Rocks, TAS, 7255",
  "Blue Vale, NSW, 2380",
  "Bluewater, QLD, 4818",
  ...
  "Brisbane Mackenzie, QLD, 4156",
  "Brisbane Market, QLD, 4106",
  "Brisbane West End, QLD, 4101",
  "Brit Brit, VIC, 3315",
  ...
  "Broadwater, QLD, 4380",
  "Broadwater, WA, 6280",
  "Broadwater (Merimbula), VIC, 3301",
  "Broadwater (Woodburn), NSW, 2549",
  "Broadway, NSW, 2007",
  "Broadway, NSW, 2581",
  ...
  "Bungaree, SA, 5464",
  "Bungaree, VIC, 3352",
  "Bungarribee (King Island), NSW, 2767",
  ...
  "Burketown, QLD, 4830",
  "Burleigh, QLD, 4822",
  "Burleigh Dc (Richmond Shire), QLD, 4220",
  "Burlong, WA, 6401",
  "Burma Road, WA, 6532",
  "Burnbank, VIC, 3371",
  "Burncluith, QLD, 4413",
  ...
  "Burpengary, QLD, 4505",
  "Burra, NSW, 2620",
  "Burra (Queanbeyan), NSW, 2653",
  "Burra (Tumbarumba), SA, 5417",
  ...
  "Cairns Rocky Point, QLD, 4873",
  "Cairns White Rock, QLD, 4868",
  "Calala, NSW, 2340",
  "Calamia, NSW, 2460",
  "Calamvale, QLD, 4116",
  "Calavos, QLD, 4670",
  ...
  "Cardup, WA, 6122",
  "Cardwell, QLD, 4849",
  "Care Po Kiwirrkurra, WA, 0872",
  "Care Po Maranboy, NT, 0852",
  "Care Po Oenpelli, NT, 0822",
  "Care Po Pularumpi, NT, 0822",
  "Carew, SA, 5270",
  "Carey Bay, NSW, 2283",
  "Carey Gully, SA, 5144",
  "Carey Park, WA, 6230",
  ...
  "Carrieton, SA, 5432",
  "Carringbah Lilli Pilli, NSW, 2229",
  "Carrington, NSW, 2294",
  "Carrington, NSW, 2324",
  "Carrington (Raymond Terrace), QLD, 4883",
  ...
  "Casey, ACT, 2913",
  "Casey, TAS, 7151",
  "Cashmere (Territory), QLD, 4500",
  "Cashmore, VIC, 3305",
  "Casino, NSW, 2470",
  "Casino Swan Bay, NSW, 2471",
  "Cassilis, NSW, 2329",
  "Cassilis, VIC, 3898",
  "Cassini, SA, 5223",
  "Cassowary, QLD, 4873",
  ...
  "Cattle Creek (Toowoomba), QLD, 4626",
  "Catumnal, VIC, 3537",
  "Caulfield, VIC, 3162",
  ...
  "Cedar Creek (Gold Coast / Logan), QLD, 4520",
  "Cedar Creek (Murwillumbah), QLD, 4207",
  ...
  "Charles Sturt University, NT, 0909",
  "Charleston, SA, 5244",
  ...
  "Coalville, VIC, 3825",
  "Coast St Helens (Fraser), TAS, 7216",
  ...
  "Coffs Harbour Sherwood, NSW, 2450",
  "Coggan, NSW, 2849",
  ...
  "Colly Blue, NSW, 2343",
  "Colo, NSW, 2756",
  "Colo (Windsor), NSW, 2795",
  "Colo Heights (Bathurst), NSW, 2756",
  "Colo Vale, NSW, 2575",
  ...
  "Commodine, WA, 6311",
  "Commonwealth Offices Parramatta, NSW, 2123",
  "Como, NSW, 2226",
  "Como, QLD, 4571",
  "Como, WA, 6152",
  "Como, WA, 6952",
  ...
  "Coolangatta (Shoalhaven), QLD, 4225",
  "Coolaroo, VIC, 3048",
  "Coolatai, NSW, 2402",
  "Coolbellup, WA, 6163",
  "Coolbinia, WA, 6050",
  ...
  "Currie, TAS, 7256",
  "Currimundi (King Island), QLD, 4551",
  "Currowan, NSW, 2536",
  "Currumbin, QLD, 4223",
  "Currumbin Ters, QLD, 4223",
  ...
  "Dalwogon, QLD, 4415",
  "Dalwood, NSW, 2335",
  "Dalwood (Branxton), NSW, 2477",
  "Daly River, NT, 0822",
  "Daly River (Ballina), NT, 0822",
  "Daly Ters, NT, 0852",
  "Daly Waters, NT, 0852",
  "Dalyellup, WA, 6230",
  "Dalyenong, VIC, 3477",
  ...
  "Darlington, SA, 5047",
  "Darlington, WA, 6070",
  "Darlington (Chippendale), NSW, 2330",
  "Darlington (Singleton), VIC, 3271",
  ...
  "Deep Creek, SA, 5204",
  "Deep Creek, QLD, 4625",
  "Deep Creek (Baryulgil), NSW, 2469",
  "Deep Creek (Kempsey), NSW, 2460",
  "Deep Creek (Tabulam), QLD, 4625",
  "Deep Lead, VIC, 3385",
  "Deepdale, WA, 6532",
  "Deepdene, VIC, 3103",
  "Deepdene, WA, 6290",
  ...
  "District Section B, VIC, 3549",
  "District Section C, VIC, 3549",
  "District Section D, VIC, 3549",
  "District Section E, VIC, 3549",
  "Districts, SA, 5417",
  "Dittmer, QLD, 4800",
  "Diwan, QLD, 4873",
  "Dixalea, QLD, 4702",
  ...
  "Downer, ACT, 2602",
  "Downlands, TAS, 7320",
  "Downs Cannon Hill (Southern), QLD, 4170",
  "Downsfield, QLD, 4570",
  "Downside, NSW, 2650",
  "Dows Creek, QLD, 4754",
  ...
  "East Geelong Thomson, VIC, 3219",
  "East Gga Gga, NSW, 2650",
  ...
  "Elphinstone (Toowoomba), QLD, 4742",
  "Elrington, NSW, 2325",
  "Elsmore, NSW, 2360",
  ...
  "Fairy Dell, VIC, 3561",
  "Fairy Dell (Rochester), VIC, 3875",
  "Fairy Hill (Bairnsdale), NSW, 2470",
  ...
  "Frankton, SA, 5374",
  "Fraser, ACT, 2615",
  "Fraser Coast St Helens, QLD, 4650",
  ...
  "Glen Huon, TAS, 7109",
  "Glen Innes, NSW, 2370",
  "Glen Innes Lambs Valley, NSW, 2370",
  "Glen Innes Morven, NSW, 2370",
  "Glen Iris, VIC, 3146",
  "Glen Iris, WA, 6230",
  "Glen Iris, VIC, 3146",
  "Glen Isla, QLD, 4800",
  ...
  "Glenroy, SA, 5277",
  "Glenroy, VIC, 3046",
  "Glenroy (Albury), NSW, 2653",
  "Glenroy (Tumbarumba), VIC, 3046",
  "Glenside, SA, 5065",
  ...
  "Gol Gol, NSW, 2738",
  "Golconda, TAS, 7254",
  "Gold Coast / Logan Cedar Creek, QLD, 4207",
  ...
  "Golden Point (Ballarat), VIC, 3451",
  ...
  "Gowrie, NSW, 2330",
  "Gowrie, NSW, 2340",
  "Gowrie (Singleton), NSW, 2340",
  "Gowrie (Tamworth), ACT, 2904",
  ...
  "Grassy, TAS, 7256",
  "Grassy Head (King Island), NSW, 2441",
  "Grattai, NSW, 2850",
  ...
  "Great Lakes Washpool, NSW, 2425",
  "Great Mackerel Beach, NSW, 2108",
  "Great Marlow, NSW, 2460",
  "Great Ndy Strait, QLD, 4655",
  ...
  "Green Point (Gosford), NSW, 2428",
  "Green Range (Forster), WA, 6328",
  ...
  "Greenlands, NSW, 2631",
  "Greenlands, QLD, 4380",
  "Greenlands (Nimmitabel), QLD, 4380",
  "Greenlands (Singleton), NSW, 2631",
  "Greenleigh, NSW, 2620",
  "Greenmount, QLD, 4359",
  "Greenmount, QLD, 4751",
  "Greenmount, WA, 6056",
  "Greenmount (Mackay), WA, 6056",
  "Greenock, SA, 5360",
  "Greenough, WA, 6532",
  "Greenridge, NSW, 2471",
  ...
  "Greigs Flat (Whitsunday), NSW, 2549",
  "Grenfell, NSW, 2810",
  "Grenville, VIC, 3352",
  "Gresford, NSW, 2311",
  "Greta, NSW, 2334",
  ...
  "Happy Valley (Mount Isa), SA, 5159",
  "Happy Valley (Robinvale), QLD, 4825",
  "Harcourt, VIC, 3453",
  ...
  "Heidelberg West Bellfield, VIC, 3381",
  ...
  "Hillgrove, NSW, 2350",
  "Hillgrove, NSW, 2650",
  "Hillier (Wagga Wagga), SA, 5116",
  "Hillman, WA, 6168",
  "Hillsborough, NSW, 2290",
  "Hillsborough, NSW, 2320",
  "Hillsdale (Maitland), NSW, 2036",
  "Hillside, VIC, 3037",
  "Hillside, VIC, 3875",
  "Hillside, WA, 6312",
  "Hillside (Sydenham), VIC, 3875",
  "Hillston, NSW, 2675",
  "Hilltown, SA, 5455",
  "Hillview, QLD, 4285",
  "Hillville, NSW, 2430",
  ...
  "Hinchinbrook Long Pocket, QLD, 4850",
  "Hincks, SA, 5603",
  "Hindmarsh, SA, 5007",
  "Hindmarsh, WA, 6462",
  ...
  "Iona, VIC, 3815",
  "Ipswich, QLD, 4305",
  "Ipswich The Bluff, QLD, 4340",
  "Ipswich White Rock, QLD, 4306",
  "Iraak, VIC, 3494",
  "Iredale, QLD, 4344",
  "Irishtown, TAS, 7330",
  "Irishtown, VIC, 3451",
  ...
  "Island Eurongilly (Fraser), NSW, 2663",
  ...
  "Killara, VIC, 3312",
  "Killara, VIC, 3691",
  "Killara (Henty), VIC, 3691",
  "Killarney, QLD, 4373",
  "Killarney, VIC, 3283",
  "Killarney (Wodonga), VIC, 3283",
  ...
  "Kindred, TAS, 7310",
  "King Creek, NSW, 2446",
  "King Island Bungaree, TAS, 7256",
  "King Island Currie, TAS, 7256",
  "King Island Grassy, TAS, 7256",
  "King Island Lymwood, TAS, 7256",
  "King Island Naracoopa, TAS, 7256",
  "King Island Nugara, TAS, 7256",
  "King Island Pearshape, TAS, 7256",
  "King Island Pegarah, TAS, 7256",
  "King Island Reekara, TAS, 7256",
  "King Island Sea Elephant, TAS, 7256",
  "King Island Surprise Bay, TAS, 7256",
  "King Island Wickham, TAS, 7256",
  "King Island Yambacoona, TAS, 7256",
  "King Island Yarra Creek, TAS, 7256",
  ...
  "Kings Plains (Inverell), NSW, 2799",
  ...
  "Lanitza (Baxter), NSW, 2460",
  "Lankeys Creek, NSW, 2644",
  "Lannercost, QLD, 4850",
  "Lansdowne, NSW, 2163",
  "Lansdowne, NSW, 2430",
  "Lansdowne, QLD, 4478",
  "Lansdowne (Taree), QLD, 4478",
  "Lansdowne (Villawood), NSW, 2430",
  ...
  "Lilli Pilli (Carringbah), NSW, 2536",
  ...
  "Lockyer, QLD, 4344",
  "Lockyer, WA, 6330",
  "Lockyer Ters, QLD, 4311",
  "Lockyer Valley Spring Creek, QLD, 4343",
  "Loddon, VIC, 3516",
  ...
  "Long Plain, NSW, 2360",
  "Long Plain, NSW, 2629",
  "Long Plain (Inverell), NSW, 2629",
  "Long Plains, SA, 5501",
  "Long Plains (Adaminaby), SA, 5501",
  "Long Pocket, QLD, 4850",
  "Long Point, NSW, 2564",
  "Long Point, NSW, 2330",
  "Long Point (Hinchinbrook), NSW, 2330",
  "Long Reach, TAS, 7253",
  "Long Reach (Macquarie), TAS, 7253",
  "Longarm, NSW, 2347",
  ...
  "Lower Mount Lker, QLD, 4340",
  "Lower Ndy Bay, TAS, 7005",
  ...
  "Mackay Dc, QLD, 4740",
  "Mackay Greenmount, QLD, 4751",
  "Mackay Harbour, QLD, 4740",
  "Mackay Mc, QLD, 4741",
  "Mackay North, QLD, 4740",
  "Mackay South, QLD, 4740",
  "Mackay Sunnyside, QLD, 4737",
  "Mackenzie, QLD, 4156",
  "Mackenzie, QLD, 4702",
  "Mackenzie (Brisbane), QLD, 4702",
  ...
  "Macquarie Limekilns (Port), NSW, 2795",
  ...
  "Maryland, NSW, 2287",
  "Maryland, NSW, 4377",
  "Marys Creek (Tenterfield), QLD, 4570",
  ...
  "Mawson, ACT, 2607",
  "Mawson, TAS, 7151",
  "Mawson Lakes (Territory), SA, 5095",
  "Maxwell, NSW, 2650",
  "Maxwelton, QLD, 4822",
  "May Downs, QLD, 4746",
  "Maya, WA, 6614",
  ...
  "Mayfield, NSW, 2787",
  "Mayfield, SA, 5454",
  "Mayfield (Goulburn), NSW, 2787",
  "Mayfield (Newcastle), NSW, 2540",
  "Mayfield (Nowra), NSW, 2580",
  "Mayfield (Oberon), SA, 5454",
  ...
  "Medway, NSW, 2577",
  "Medway, NSW, 2820",
  "Meekatharra (Wellington), WA, 6642",
  "Meeking, WA, 6392",
  "Meelon, WA, 6208",
  "Meenaar, WA, 6401",
  "Meeniyan, VIC, 3956",
  ...
  "Melbourne, SA, 8001",
  "Melbourne, VIC, 8001",
  "Melbourne (District), SA, 8001",
  "Melbourne Airport, VIC, 3045",
  "Melbourne St, SA, 5006",
  ...
  "Milroy, NSW, 2380",
  "Milroy, NSW, 2850",
  "Milroy (Gunnedah), NSW, 2850",
  "Milsons Arm (Mudgee), NSW, 2325",
  ...
  "Montrose, QLD, 4413",
  "Montrose, VIC, 3765",
  "Montrose (Dalby), TAS, 7010",
  "Montrose (Southern Downs), QLD, 4413",
  "Montumana, TAS, 7321",
  "Montville, QLD, 4560",
  "Mooball, NSW, 2483",
  "Moobi, NSW, 2337",
  ...
  "Moresby, QLD, 4871",
  "Moresby, WA, 6530",
  "Moreton Bay Cedar Creek, QLD, 4520",
  ...
  "Morven, NSW, 2660",
  "Morven, QLD, 4468",
  "Morven (Culcairn), QLD, 4468",
  "Morven (Glen Innes), NSW, 2660",
  "Morwell, VIC, 3840",
  "Morwincha, QLD, 4309",
  "Moseley, SA, 5641",
  "Mosman, NSW, 2088",
  ...
  "Moss Vale, NSW, 2577",
  "Moss Vale Paddys River, NSW, 2577",
  "Mossgiel, NSW, 2878",
  "Mossiface, VIC, 3885",
  "Mossman, QLD, 4873",
  ...
  "Mount Lker, QLD, 4340",
  "Mount Lker, WA, 6369",
  "Mount Lker West, QLD, 4340",
  "Mount Llace, VIC, 3342",
  ...
  "Mount Olive (Singleton), NSW, 2787",
  ...
  "Murwillumbah Back Creek, NSW, 2622",
  ...
  "Naracoopa, TAS, 7256",
  "Naracoorte (King Island), SA, 5271",
  "Naradhan, NSW, 2669",
  "Naraling, WA, 6532",
  "Narangba, QLD, 4504",
  "Narara, NSW, 2250",
  ...
  "Narrawong, VIC, 3285",
  "Narre Rren, VIC, 3805",
  "Narre Rren East, VIC, 3804",
  "Narre Rren North, VIC, 3804",
  "Narre Rren South, VIC, 3805",
  "Narridy, SA, 5523",
  "Narrikup, WA, 6326",
  "Narrogin, WA, 6312",
  ...
  "National Park, WA, 6338",
  "National Park, WA, 6537",
  "Natone, TAS, 7321",
  "Nattai, NSW, 2570",
  ...
  "Newcastle Mayfield, NSW, 2304",
  "Newcastle Ters, NT, 0862",
  ...
  "Newtown, VIC, 3220",
  "Newtown, VIC, 3351",
  "Newtown (Geelong), VIC, 3351",
  "Newtown (Ipswich), QLD, 4350",
  "Newtown (Scarsdale), QLD, 4305",
  "Ngapala (Toowoomba), SA, 5374",
  "Ngarkat, SA, 5302",
  "Ngukurr, NT, 0852",
  "Ngunnawal, ACT, 2913",
  "Nhill, VIC, 3418",
  ...
  "Paling Yards (Goulburn), NSW, 2795",
  "Palkagee, SA, 5670",
  "Pallal, NSW, 2404",
  ...
  "Park Yellow Rock (Albion), NSW, 2777",
  "Parkdale, VIC, 3195",
  ...
  "Parramatta, NSW, 2124",
  "Parramatta, NSW, 2150",
  "Parramatta (Commonwealth Offices), NSW, 2124",
  ...
  "Pearsall, WA, 6065",
  "Pearshape, TAS, 7256",
  "Pearsondale (King Island), VIC, 3851",
  ...
  "Pegarah, TAS, 7256",
  "Pegs Creek, WA, 6714",
  "Pegs Creek (King Island), WA, 6714",
  "Pejar, NSW, 2583",
  "Pekina, SA, 5431",
  "Pelaw Main, NSW, 2327",
  "Pelham, TAS, 7030",
  ...
  "Perth Bc, WA, 6849",
  "Perth East St Georges Tce, WA, 6832",
  "Perth Gpo, WA, 6000",
  ...
  "Po Bags Alice Springs, NT, 0872",
  "Po Bags Katherine, NT, 0852",
  "Po Bags Tailem Bend, SA, 5259",
  "Po Bags Tennant Creek, NT, 0862",
  "Po Bags Winnellie, NT, 0822",
  "Poatina, TAS, 7302",
  ...
  "Pretty Pine (Ulladulla), NSW, 2710",
  "Prevelly, WA, 6285",
  "Price, SA, 5570",
  "Priestdale, QLD, 4127",
  "Primbee, NSW, 2502",
  "Primrose Nds, TAS, 7173",
  "Primrose Valley, NSW, 2621",
  "Prince Henry Heights, QLD, 4350",
  "Prince Of Les, QLD, 4875",
  ...
  "Punchbowl, NSW, 2196",
  "Punchbowl, NSW, 2460",
  "Punchbowl (Bankstown), NSW, 2460",
  "Punchbowl (Grafton), TAS, 7249",
  ...
  "Quedjinup, WA, 6281",
  "Queen Toria Building, NSW, 1230",
  "Queen Victoria Quedjinup, WA, 6281",
  ...
  "Raaf Base Willigobung, NSW, 2653",
  "Raby, NSW, 2566",
  "Racecourse, QLD, 4740",
  ...
  "Red Hill, VIC, 3937",
  "Red Hill, WA, 6056",
  "Red Hill (Barraba), ACT, 2603",
  "Red Hill (Tumut), NSW, 2824",
  "Red Hill (Warren), VIC, 3937",
  ...
  "Reedy Creek (Rylstone), VIC, 3658",
  "Reedy Creek (Singleton), NSW, 2849",
  "Reedy Dam, VIC, 3395",
  "Reedy Flat, VIC, 3895",
  "Reedy Lake, VIC, 3579",
  ...
  "Reefton, VIC, 3799",
  "Reekara, TAS, 7256",
  "Reesville (King Island), QLD, 4552",
  ...
  "Rocky Point (Cairns), QLD, 4874",
  "Rocky River, NSW, 2358",
  "Rocky River, NSW, 2372",
  "Rockyview (Tenterfield), QLD, 4701",
  "Rodd Point, NSW, 2046",
  "Rodds Bay, QLD, 4678",
  ...
  "Rose Valley (Gerringong), NSW, 2630",
  "Rosebank (Cooma), NSW, 2480",
  "Roseberg, NSW, 2793",
  "Roseberry, NSW, 2474",
  ...
  "Rosewood, NSW, 2652",
  "Rosewood, QLD, 4340",
  "Rosewood (Tumbarumba), QLD, 4340",
  "Rosewood (Wauchope), NSW, 2652",
  "Roseworthy, SA, 5371",
  "Roslyn, NSW, 2580",
  "Roslynmead, VIC, 3564",
  "Rosny, TAS, 7018",
  ...
  "Roxby Downs, SA, 5725",
  "Royal Australian Navy Roxby Downs, SA, 5725",
  "Royal Australian Navy Rships, WA, 6958",
  ...
  "Sandy Creek (Cobar), VIC, 3695",
  "Sandy Creek (Murrurundi), NSW, 2835",
  ...
  "Sea Lake (King Island), VIC, 3533",
  "Sea Lake Myall, VIC, 3579",
  "Sea Lake Springfield, QLD, 4300",
  "Sea Lake Springfield, VIC, 3544",
  "Seabird, WA, 6042",
  "Seabrook, VIC, 3028",
  "Seacliff, SA, 5049",
  ...
  "Shenton Park (Townsville), WA, 6008",
  ...
  "Sherwood, QLD, 4075",
  "Sherwood, SA, 5267",
  "Sherwood (Kempsey), NSW, 2450",
  "Sherwood (Kyogle), QLD, 4075",
  "Shirbourne, QLD, 4809",
  "Shire Hideaway Bay (Livingstone), QLD, 4800",
  "Shire North Haven (Isis), NSW, 2443",
  "Shoal Bay, NSW, 2315",
  ...
  "Silverwater (Lidcombe), NSW, 2264",
  "Silverwood (Morisset), QLD, 4370",
  "Simmie, QLD, 4454",
  ...
  "Smiths Creek (Grafton), NSW, 2474",
  "Smiths Creek (Kyogle), NSW, 2484",
  "Smiths Gully (Murwillumbah), VIC, 3760",
  ...
  "South Arm, NSW, 2449",
  "South Arm, NSW, 2460",
  "South Arm (Bowraville), NSW, 2460",
  "South Arm (Grafton), TAS, 7022",
  ...
  "Southern Downs Montrose, QLD, 4370",
  "Southern Downs Sugarloaf, QLD, 4380",
  ...
  "Spring Creek (Toowoomba), QLD, 4420",
  "Spring Farm, SA, 5453",
  "Spring Farm (Banana), NSW, 2570",
  ...
  "Spring Hill (Orange), VIC, 3444",
  "Spring Hill (Wollongong), NSW, 2800",
  ...
  "Springfield, WA, 6525",
  "Springfield (Gosford), NSW, 2630",
  "Springfield (Romsey), VIC, 3544",
  ...
  "Springvale, NSW, 2790",
  "Springvale, VIC, 3171",
  "Springvale (Lithgow), VIC, 3171",
  "Springvale (Wagga Wagga), NSW, 2790",
  ...
  "Stony Creek (Mudgee), VIC, 3371",
  "Stony Creek (Talbot), VIC, 3957",
  ...
  "Sugarloaf, QLD, 4800",
  "Sugarloaf, VIC, 3234",
  "Sugarloaf (Southern Downs), QLD, 4800",
  ...
  "Sunnyside, SA, 5253",
  "Sunnyside, WA, 6256",
  "Sunnyside (Mackay), SA, 5253",
  "Sunnyside (Western Downs), QLD, 4737",
  "Sunnyvale, SA, 5552",
  ...
  "Surrey Downs (King Island), SA, 5126",
  ...
  "Swan Bay, VIC, 3225",
  "Swan Bay, TAS, 7252",
  "Swan Bay (Casino), VIC, 3225",
  "Swan Bay (Raymond Terrace), NSW, 2471",
  "Swan Creek, NSW, 2462",
  "Swan Creek, QLD, 4370",
  "Swan Creek, NSW, 2462",
  "Swan Creek, QLD, 4370",
  ...
  "The Gap, QLD, 4825",
  "The Gap, SA, 5271",
  "The Gap (Mount Isa), SA, 5271",
  "The Gap (Woodburn), NSW, 2650",
  ...
  "The University Of The Summit, QLD, 4377",
  "The Vines, WA, 6069",
  ...
  "Toowong Dc, QLD, 4066",
  "Toowoomba, QLD, 4350",
  "Toowoomba Cattle Creek, QLD, 4407",
  "Toowoomba City, QLD, 4350",
  "Toowoomba Dc, QLD, 4350",
  "Toowoomba Douglas, QLD, 4354",
  "Toowoomba East, QLD, 4350",
  "Toowoomba Elphinstone, QLD, 4361",
  "Toowoomba Mc, QLD, 4352",
  "Toowoomba South, QLD, 4350",
  "Toowoomba Spring Creek, QLD, 4361",
  "Toowoomba St Helens, QLD, 4356",
  "Toowoomba Stonehenge, QLD, 4357",
  ...
  "Vale Paddys River (Moss), ACT, 2620",
  "Vale Park, SA, 5081",
  "Vale View, QLD, 4352",
  ...
  "Valley Spring Creek (Lockyer), QLD, 4361",
  "Valley View, SA, 5093",
  ...
  "Wagerup, WA, 6215",
  "Wagga Gga, NSW, 2650",
  "Wagga Gga Bc, NSW, 2650",
  "Wagga Gga Raaf, NSW, 2651",
  ...
  "Wannamal, WA, 6505",
  "Wannan, WA, 0872",
  "Wannanup (Wannan Community), WA, 6210",
  "Wanneroo, WA, 6065",
  "Wanneroo, WA, 6946",
  "Wanniassa, ACT, 2903",
  "Wannon, VIC, 3301",
  ...
  "West Wyalong Back Creek, NSW, 2671",
  "West Wyalong Back Forest, NSW, 2535",
  "Westall, SA, 5680",
  ...
  "Westdale, NSW, 2653",
  "Westdale, WA, 6304",
  "Westdale (Tumbarumba), WA, 6304",
  "Western Creek, TAS, 7304",
  "Western Creek, QLD, 4357",
  "Western Downs Sunnyside, QLD, 4416",
  ...
  "Whitlands, VIC, 3678",
  "Whitlow, NSW, 2404",
  "Whitsunday Preston, QLD, 4800",
  "Whitsundays (Gwydir), QLD, 4802",
  "Whittaker, WA, 6207",
  ...
  "Wickham, NSW, 2293",
  "Wickham, WA, 6720",
  "Wickliffe (King Island), VIC, 3379",
  "Widden, NSW, 2328",
  "Widgee, QLD, 4570",
  ...
  "Willow Vale (Gerringong), NSW, 2575",
  "Willow Vale (Mittagong), QLD, 4209",
  "Willowbank, QLD, 4306",
  "Willowie, SA, 5431",
  ...
  "Woodstock, QLD, 4816",
  "Woodstock, VIC, 3751",
  "Woodstock (Cowra), VIC, 3751",
  "Woodstock (Inverell), NSW, 2538",
  "Woodstock (Milton), NSW, 2793",
  ...
  "Yarra Glen (King Island), VIC, 3775",
  ...
  "Yellowdine (Blue Mountains), WA, 6426",
  "Yelta, SA, 5558",
  "Yelta, VIC, 3505",
  "Yelverton, WA, 6280",
  "Yenda, NSW, 2681",
